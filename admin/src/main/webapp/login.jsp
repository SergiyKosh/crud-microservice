                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                <form method="post" action="/login/signIn">
                                    ...
                                    <p style="text-align: center; font-size: 12px;">Please, sign in for messaging</p>
                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                <form method="post" action="/login/signUp">
                                    <h5 class="fw-bold mb-0 mb-3" style="text-align: center;">Messenger</h5>
                                    <p style="text-align: center; font-size: 12px;">Please, sign up for messaging</p>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control rounded-4" id="floatingInput"
                                               placeholder="username"
                                               style="background-color: #212529; border-color: #55595c; color: white;"
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control rounded-4" id="floatingInput"
                                               ...
                                               style="background-color: #212529; border-color: #55595c; color: white;"
                                               name="nickname">
                                        <label for="floatingInput" style="color: #55595c;">Nickname</label>
                                        <small style="color: #55595c; font-size: 10px; text-align: center;">Nickname is used instead of first and last name.</small>
                                    </div>
